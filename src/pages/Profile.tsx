...
const Profile = () => {
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
            <div className="relative rounded-full drop-shadow-2">
              <img
                src={userSix}
                alt="profile rounded-full w-full"
                style={{
                  borderRadius: '100%',
                }}
              />
          ...
          <div className="mt-4">
            <h3 className="mb-1.5 text-2xl font-semibold text-black dark:text-white">
              {`${
                !_.isNil(profileUser?.firstName)
                  ? profileUser?.firstName
                  : 'Thomas'
              }  ${
                !_.isNil(profileUser?.lastName)
            ...
            <h3 className="mb-1.5 text-xl text-black dark:text-white">
              {`Dashpod ID: `}
              <span className="font-semibold text-[#e94c2b]">
                {profileUser?.dashpodId ? profileUser.dashpodId : ''}
              </span>
            </h3>
            <p className="font-medium">{profileUser?.emailId}</p>

            <div className="mb-5.5 mt-2 flex flex-col justify-center items-center">
              <label
  ...
  type="text"
  id="Username"
  className="text-center rounded border border-stroke bg-gray px-4.5 py-3 w-[40%] font-semibold text-[#e94c2b] focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-[#e94c2b] dark:focus:border-primary"
  value={profileUser?.dashpodId ? profileUser.dashpodId : ''}
  readOnly
/>
              {/* <p
                id="Username"
