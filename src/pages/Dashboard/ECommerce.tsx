...
import { selectProfiles, selectpodAddress, useAnalyseGraphData, useGraphData, useProfiles, userData } from '../../store/dashboardAtom.ts';
...
const ECommerce = () => {
  ...
  // const [analyseGraph,setAnalyseGraph] = useAtom(useAnalyseGraphData)
